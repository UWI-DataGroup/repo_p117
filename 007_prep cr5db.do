...
**  DO-FILE METADATA
    ...
    // 	date last modified      07-FEB-2022
...
*/
import excel using "`datapath'\version08\1-input\2022-02-07_MAIN Source+Tumour+Patient_2018_JC_excel.xlsx", firstrow
...
count if tumourtot==. //289
count if sourcetot==. //289
...
save "`datapath'\version08\2-working\2015_cancer_dups_prematch" ,replace
...
** Death Matching **
********************
use "`datapath'\version08\2-working\2015_cancer_dups_prematch", clear
...
frame create deaths
frame change deaths
use "`datapath'\version08\3-output\2015-2018_deaths_for_matching", clear
frame change cancer
...
merge m:m lname fname sex using "`datapath'\version08\3-output\2015-2018_deaths_for_matching"
/*
    Result                           # of obs.
    -----------------------------------------
    not matched                        10,563
...
save "`datapath'\version08\2-working\2015_unmatched death certificates" ,replace
restore
...
save "`datapath'\version08\2-working\2015_ineligible cancers" ,replace
restore

preserve
use "`datapath'\version08\2-working\2015_ineligible cancers" ,clear
merge m:m natregno using "`datapath'\version08\2-working\2015_unmatched death certificates"
sort lname fname record_id pid
quietly by lname fname :  gen duppt = cond(_N==1,0,_n)
sort lname fname
count if duppt>0 //2198
...
preserve
clear
import excel using "`datapath'\version08\1-input\2020-02-18_Exported Source+Tumour+Patient_JC_MAIN_excel.xlsx", firstrow
count //12,470
...
save "`datapath'\version08\2-working\MAIN CR5db" ,replace
...
save "`datapath'\version08\2-working\matched deaths and MAIN cr5" ,replace
...
save "`datapath'\version08\2-working\MAIN CR5db_matched death certificates" ,replace
restore

** Check all unmatched death certificates with cancer CODs
rename _merge _merge_org
merge m:m record_id using "`datapath'\version08\2-working\MAIN CR5db_matched death certificates"
/*
    Result                           # of obs.
    -----------------------------------------
    not matched                        11,561
...
count //163
save "`datapath'\version08\2-working\2015_death certificates_DCOs" ,replace
restore
...
capture export_excel record_id fname lname nationalID deathdate cods dd_certifier placeofdeath regnum district ///
		...
		using "`datapath'\version08\2-working\DCO2015V05.xlsx", sheet("2015 DCOs_deathdata_20210727") firstrow(variables) replace
...
save "`datapath'\version08\2-working\2015_DCOs" ,replace
clear
use "`datapath'\version08\2-working\2015_DCOs" ,clear
...
notes _dta :These data prepared from CanReg5 CLEAN (2015BNR-C) database
save "`datapath'\version08\2-working\2015_cancer_dups_matched" ,replace
note: TS This dataset can be used for assessing number of sources per record
...
putdocx save "`datapath'\version08\3-output\2021-08-12_DQI.docx", replace
putdocx clear

save "`datapath'\version08\2-working\2015_cancer_dqi_dups.dta" ,replace
...
putdocx save "`datapath'\version08\3-output\2021-08-12_DQI.docx", append
putdocx clear

save "`datapath'\version08\2-working\2015_cancer_dqi_source.dta" ,replace
...
notes _dta :These data prepared from CanReg5 CLEAN (2015BNR-C) database
save "`datapath'\version08\2-working\2015_cancer_dups" ,replace
...
notes _dta :These data prepared from CanReg5 CLEAN (2015BNR-C) database
save "`datapath'\version08\2-working\2015_cancer_nodups" ,replace
...
** 2019 Death Matching **
*************************
use "`datapath'\version08\2-working\2015_cancer_nodups", clear
...
drop _merge
merge m:m lname fname sex using "`datapath'\version08\3-output\2019_deaths_for_matching"
/*
    Result                           # of obs.
    -----------------------------------------
    not matched                         3,812
...
label data "BNR-Cancer data - 2015 Incidence: No duplicates"
notes _dta :These data prepared from CanReg5 CLEAN (2015BNR-C) database
save "`datapath'\version08\2-working\2015_cancer_nodups_matched" ,replace
note: TS This dataset can be used for final cleaning

*****************************
**   Final Clean and Prep  **
*****************************
use "`datapath'\version08\2-working\2015_cancer_nodups_matched" ,clear
...
capture export_excel pid fname lname natregno dod cr5cod doctor docaddr certifier ///
		using "`datapath'\version08\2-working\DCO2015V05.xlsx", sheet("2015 DCOs_cr5data_20210727") firstrow(variables)
//JC remember to change V01 to V02 when running list a 2nd time!
restore
...
using "`datapath'\version08\2-working\2015_nonsurvival_iarccrgtools.txt", nolabel replace
...
save "`datapath'\version08\2-working\2008_cancer_nonsurvival_2015extras", replace
...
save "`datapath'\version08\2-working\2013_cancer_nonsurvival_2015extras", replace
...
save "`datapath'\version08\2-working\2014_cancer_nonsurvival_2015extras", replace
...
save "`datapath'\version08\2-working\2015_cancer_nonsurvival", replace
...
use "`datapath'\version08\3-output\2008_2013_2014_cancer_nonsurvival_bnr_reportable", replace
count //2417; 2961
...
save "`datapath'\version08\2-working\20130414_18963_deathmatching" ,replace
restore

preserve
use "`datapath'\version08\3-output\2015-2018_deaths_for_matching", replace
...
save "`datapath'\version08\2-working\18963_20130414_deathmatching" ,replace
restore

preserve
use "`datapath'\version08\2-working\20130414_18963_deathmatching", clear
...
drop _merge
merge 1:1 natregno using "`datapath'\version08\2-working\18963_20130414_deathmatching"
save "`datapath'\version08\2-working\18963_20130414_deathmatched" ,replace
restore

drop if pid=="20130414"
append using "`datapath'\version08\2-working\18963_20130414_deathmatched"
...
append using "`datapath'\version08\2-working\2008_cancer_nonsurvival_2015extras" ,force
count //2421; 2423; 2967
append using "`datapath'\version08\2-working\2013_cancer_nonsurvival_2015extras" ,force
count //2431; 2436; 2980
append using "`datapath'\version08\2-working\2014_cancer_nonsurvival_2015extras" ,force
count //2445; 2456; 3000
append using "`datapath'\version08\2-working\2015_cancer_nonsurvival_bnr_reportable" ,force
...
using "`datapath'\version08\2-working\2008_2013_2014_2015_nonsurvival_iarccrgtools.txt", nolabel replace
...
preserve
clear
import excel using "`datapath'\version08\1-input\2013-2015MissingResidentsV01_NS.xlsx" , firstrow case(lower)
...
save "`datapath'\version08\2-working\2013-2015_unk_resident" ,replace
restore

drop _merge
merge 1:1 pid cr5id using "`datapath'\version08\2-working\2013-2015_unk_resident"
...
preserve
clear
import excel using "`datapath'\version08\2-working\PostCleaningPartialUpdates20210721.xlsx" , firstrow case(lower)
tostring pid ,replace
drop if pid==""
format dob %dD_m_CY
tostring natregno ,replace
...
save "`datapath'\version08\2-working\postcleanpartupdates" ,replace
restore
merge 1:1 pid cr5id using "`datapath'\version08\2-working\postcleanpartupdates" ,update replace
/*
    Result                           # of obs.
    -----------------------------------------
    not matched                         4,051
...
preserve
clear
import excel using "`datapath'\version08\2-working\PostCleaningFullUpdates20210721.xlsx" , firstrow case(lower)
tostring pid ,replace
tostring natregno ,replace
...
save "`datapath'\version08\2-working\postcleanfullupdates" ,replace
restore
append using "`datapath'\version08\2-working\postcleanfullupdates"
/*
...
save "`datapath'\version08\2-working\2008_2013_2014_2015_cancer ds_2015-2020 death matching", replace

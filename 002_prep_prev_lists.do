...
** NRN list
capture import excel using "`datapath'\version07\1-input\CancerDuplicates20211117.xlsx" , sheet(NRN) firstrow case(lower)
...
** DOB list
capture import excel using "`datapath'\version07\1-input\CancerDuplicates20211117.xlsx" , sheet(DOB) firstrow case(lower)
...
** Hosp# list
capture import excel using "`datapath'\version07\1-input\CancerDuplicates20211117.xlsx" , sheet(Hosp#) firstrow case(lower)

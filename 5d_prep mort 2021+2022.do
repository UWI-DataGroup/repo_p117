** HEADER -----------------------------------------------------
**  DO-FILE METADATA
    //  algorithm name          5d_prep_mort 2021+2022.do
    //  project:                BNR
    //  analysts:               Jacqueline CAMPBELL & Kern ROCKE
    //  date first created      19-SEPT-2023
...
drop if dodyear!=2021 & dodyear!=2022 //10,027 deleted
...
preserve
clear
import excel using "`datapath'/version13/2-working/MissingNRNs_mort_20220614.xlsx" , firstrow case(lower)
...
label data "BNR MORTALITY data 2021 + 2022"
notes _dta :These data prepared from BB national death register & Redcap deathdata database
save "`datapath'/version13/3-output/2021_2022_prep mort_ALL" ,replace
note: TS This dataset is used for analysis of age-standardized mortality rates
note: TS This dataset includes all 2021 + 2022 CODs
...
label data "BNR MORTALITY data 2021 + 2022: Identifiable Dataset"
notes _dta :These data prepared from BB national death register & Redcap deathdata database
save "`datapath'/version13/3-output/2021+2022_prep mort_identifiable" ,replace
note: TS This dataset is used for analysis of age-standardized mortality rates
...
label data "BNR MORTALITY data 2021 + 2022: De-identified Dataset"
notes _dta :These data prepared from BB national death register & Redcap deathdata database
save "`datapath'/version13/3-output/2021+2022_prep mort_deidentified" ,replace
note: TS This dataset is used for analysis of age-standardized mortality rates
note: TS This dataset includes patients with multiple eligible cancer causes of death
restore

** Save separate datasets for 2021 and 2022
preserve
drop if dodyear!=2021
label data "BNR MORTALITY data 2021: Identifiable Dataset"
notes _dta :These data prepared from BB national death register & Redcap deathdata database
save "`datapath'/version13/3-output/2021_prep mort_identifiable" ,replace
note: TS This dataset is used for analysis of age-standardized mortality rates
note: TS This dataset includes patients with multiple eligible cancer causes of death
** Create corrected dataset with reportable cases but de-identified data
drop fname lname natregno nrn pname mname dob parish regnum address pod placeofdeath certifier certifieraddr
...
notes _dta :These data prepared from BB national death register & Redcap deathdata database
save "`datapath'/version13/3-output/2021_prep mort_deidentified" ,replace
note: TS This dataset is used for analysis of age-standardized mortality rates
note: TS This dataset includes patients with multiple eligible cancer causes of death
restore

preserve
drop if dodyear!=2022
label data "BNR MORTALITY data 2022: Identifiable Dataset"
notes _dta :These data prepared from BB national death register & Redcap deathdata database
save "`datapath'/version13/3-output/2022_prep mort_identifiable" ,replace
note: TS This dataset is used for analysis of age-standardized mortality rates
note: TS This dataset includes patients with multiple eligible cancer causes of death
** Create corrected dataset with reportable cases but de-identified data
drop fname lname natregno nrn pname mname dob parish regnum address pod placeofdeath certifier certifieraddr
** Save this death dataset with de-identified data
label data "BNR MORTALITY data 2022: De-identified Dataset"
notes _dta :These data prepared from BB national death register & Redcap deathdata database
save "`datapath'/version13/3-output/2022_prep mort_deidentified" ,replace
note: TS This dataset is used for analysis of age-standardized mortality rates
note: TS This dataset includes patients with multiple eligible cancer causes of death
restore
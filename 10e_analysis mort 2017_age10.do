** HEADER -----------------------------------------------------
**  DO-FILE METADATA
    //  algorithm name          10e_analysis mort_2017_age10.do
    //  project:                BNR
    ...
    ** Close any open log file and open a new log file
    capture log close
    log using "`logpath'\10e_analysis mort_2017_age10.smcl", replace
** HEADER -----------------------------------------------------
...
merge m:m sex age_10 using "`datapath'\version09\2-working\pop_wpp_2017-10"
/*

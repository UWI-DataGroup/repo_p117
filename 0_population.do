** HEADER -----------------------------------------------------
**  DO-FILE METADATA
    //  algorithm name			0_population.do
    //  project:				BNR
    //  analysts:				Jacqueline CAMPBELL / Kern ROCKE
    //  date first created      04-SEPT-2023
    // 	date last modified	    04-SEPT-2023
    //  algorithm task			Prep for external population for incidence and mortality analyses
    //  status                  Completed
    //  objective               To have one dataset with 2008, 2013, 2014, 2015, 2018, 2019 population data for 2019 cancer report.
	...
	//							(2) 2008-2019 World Population Prospects (https://population.un.org/wpp/Download/Standard/Population/) checked previously-generated with ones on
...
*use "`datapath'\version13\1-input\barbados_adjusted_population_2000", clear
use "`datapath'/version13/1-input/barbados_adjusted_population_2000", clear
...
** Save the dataset
*save "`datapath'\version13\2-working\bb2010_5" , replace
save "`datapath'/version13/2-working/bb2010_5" , replace
...
collapse (sum) pop , by(age45 age55 age65 intdn)
	...
	sort age45
save "`datapath'/version13/2-working/who2000_45", replace

collapse (sum) pop , by(age55 age65 intdn)
	label data "WHO world standard million: 2 age groups. <55 and 55 & over"
	sort age55
save "`datapath'/version13/2-working/who2000_55", replace
...
collapse (sum) pop , by(age65 intdn)
	...
	sort age65
save "`datapath'/version13/2-working/who2000_64", replace
restore
...
collapse (sum) pop , by(age65 intdn)
	...
	sort age65
save "`datapath'/version13/2-working/who2000_65", replace
restore
...
collapse (sum) pop_segi , by(age65 intdn)
	...
	sort age65
save "`datapath'/version13/2-working/whosegi2000_64", replace
restore
...
collapse (sum) pop_segi , by(age65 intdn)
	...
	sort age65
save "`datapath'/version13/2-working/whosegi2000_65", replace
restore

clear

** JC 10may2022: No longer using BSS population ds so disabled this code.
...
import excel using "`datapath'/version13/1-input\BSS.xlsx" , describe
forvalues i=7(-1)1 {  
import excel using "`datapath'/version13/1-input\BSS.xlsx", ///
...
import excel using "`datapath'/version13/1-input\BSS.xlsx", ///
         sheet(Sheet`i') cellrange(A2:D38) clear
if `i'==7 {
    save "`datapath'/version13/2-working/pop_bss", replace
  }
  else {
    append using "`datapath'/version13/2-working/pop_bss.dta"
    save "`datapath'/version13/2-working/pop_bss", replace
  }
...
save "`datapath'/version13/2-working/pop_bss_2008-5" , replace
...
save "`datapath'/version13/2-working/pop_bss_2008-10" , replace
note: TS This dataset prepared using 2000-2009 census & estimate populations emailed from BSS' Socio-and-Demographic Statistics Division by Statistical Assistant on 29-Nov-2019.
restore
...
collapse (sum) pop_bss, by(age5 sex)
label data "BSS Population data 2013: 5-year age bands"
save "`datapath'/version13/2-working/pop_bss_2013-5" , replace
...
collapse (sum) pop_bss, by(age_10 sex)
label data "BSS Population data 2013: 10-year age bands"
save "`datapath'/version13/2-working/pop_bss_2013-10" , replace
note: TS This dataset prepared using 2010-2018 census & estimate populations emailed from BSS' Socio-and-Demographic Statistics Division by Statistical Assistant on 29-Nov-2019.
restore
...
save "`datapath'/version13/2-working/pop_bss_2014-5" , replace
note: TS This dataset prepared using 2010-2018 census & estimate populations emailed from BSS' Socio-and-Demographic Statistics Division by Statistical Assistant on 29-Nov-2019.
restore
...
save "`datapath'/version13/2-working/pop_bss_2014-10" , replace
note: TS This dataset prepared using 2010-2018 census & estimate populations emailed from BSS' Socio-and-Demographic Statistics Division by Statistical Assistant on 29-Nov-2019.
restore
...
save "`datapath'/version13/2-working/pop_bss_2015-5" , replace
note: TS This dataset prepared using 2010-2018 census & estimate populations emailed from BSS' Socio-and-Demographic Statistics Division by Statistical Assistant on 29-Nov-2019.
restore
...
save "`datapath'/version13/2-working/pop_bss_2015-10" , replace
note: TS This dataset prepared using 2010-2018 census & estimate populations emailed from BSS' Socio-and-Demographic Statistics Division by Statistical Assistant on 29-Nov-2019.
restore
...
save "`datapath'/version13/2-working/pop_bss_2016-5" , replace
note: TS This dataset prepared using 2010-2018 census & estimate populations emailed from BSS' Socio-and-Demographic Statistics Division by Statistical Assistant on 29-Nov-2019.
restore
...
save "`datapath'/version13/2-working/pop_bss_2016-10" , replace
note: TS This dataset prepared using 2010-2018 census & estimate populations emailed from BSS' Socio-and-Demographic Statistics Division by Statistical Assistant on 29-Nov-2019.
restore
...
save "`datapath'/version13/2-working/pop_bss_2017-5" , replace
note: TS This dataset prepared using 2010-2018 census & estimate populations emailed from BSS' Socio-and-Demographic Statistics Division by Statistical Assistant on 29-Nov-2019.
restore
...
save "`datapath'/version13/2-working/pop_bss_2017-10" , replace
note: TS This dataset prepared using 2010-2018 census & estimate populations emailed from BSS' Socio-and-Demographic Statistics Division by Statistical Assistant on 29-Nov-2019.
restore
...
save "`datapath'/version13/2-working/pop_bss_2018-5" , replace
note: TS This dataset prepared using 2010-2018 census & estimate populations emailed from BSS' Socio-and-Demographic Statistics Division by Statistical Assistant on 29-Nov-2019.
restore
...
save "`datapath'/version13/2-working/pop_bss_2018-10" , replace
note: TS This dataset prepared using 2010-2018 census & estimate populations emailed from BSS' Socio-and-Demographic Statistics Division by Statistical Assistant on 29-Nov-2019.
restore
...
import excel using "`datapath'/version13/1-input\wpp.xlsx" , describe
forvalues i=10(-1)1 {  
import excel using "`datapath'/version13/1-input\wpp.xlsx", ///
...
import excel using "`datapath'/version13/1-input\wpp.xlsx", ///
         sheet(Sheet`i') cellrange(A2:D37) clear
if `i'==10 {
    save "`datapath'/version13/2-working/pop_wpp", replace
  }
  else {
    append using "`datapath'/version13/2-working/pop_wpp.dta"
    save "`datapath'/version13/2-working/pop_wpp", replace
  }
...
save "`datapath'/version13/2-working/pop_wpp_2008-5" , replace
...
save "`datapath'/version13/2-working/pop_wpp_2008-10" , replace
note: TS This dataset prepared using 2000-2018 census & estimate populations generated from "https://population.un.org/wpp/Download/Standard/Population/" on 27-Nov-2019.
restore
...
save "`datapath'/version13/2-working/pop_wpp_2013-5" , replace
note: TS This dataset prepared using 2000-2018 census & estimate populations generated from "https://population.un.org/wpp/Download/Standard/Population/" on 27-Nov-2019.
restore
...
save "`datapath'/version13/2-working/pop_wpp_2013-10" , replace
note: TS This dataset prepared using 2000-2018 census & estimate populations generated from "https://population.un.org/wpp/Download/Standard/Population/" on 27-Nov-2019.
restore
...
save "`datapath'/version13/2-working/pop_wpp_2014-5" , replace
note: TS This dataset prepared using 2000-2018 census & estimate populations generated from "https://population.un.org/wpp/Download/Standard/Population/" on 27-Nov-2019.
restore
...
save "`datapath'/version13/2-working/pop_wpp_2014-10" , replace
note: TS This dataset prepared using 2000-2018 census & estimate populations generated from "https://population.un.org/wpp/Download/Standard/Population/" on 27-Nov-2019.
restore
...
save "`datapath'/version13/2-working/pop_wpp_2015-5" , replace
note: TS This dataset prepared using 2000-2018 census & estimate populations generated from "https://population.un.org/wpp/Download/Standard/Population/" on 27-Nov-2019.
restore
...
save "`datapath'/version13/2-working/pop_wpp_2015-10" , replace
note: TS This dataset prepared using 2000-2018 census & estimate populations generated from "https://population.un.org/wpp/Download/Standard/Population/" on 27-Nov-2019.
restore
...
save "`datapath'/version13/2-working/pop_wpp_2016-5" , replace
note: TS This dataset prepared using 2000-2018 census & estimate populations generated from "https://population.un.org/wpp/Download/Standard/Population/" on 27-Nov-2019.
restore
...
save "`datapath'/version13/2-working/pop_wpp_2016-10" , replace
note: TS This dataset prepared using 2000-2018 census & estimate populations generated from "https://population.un.org/wpp/Download/Standard/Population/" on 27-Nov-2019.
restore
...
save "`datapath'/version13/2-working/pop_wpp_2017-5" , replace
note: TS This dataset prepared using 2000-2018 census & estimate populations generated from "https://population.un.org/wpp/Download/Standard/Population/" on 27-Nov-2019.
restore
...
save "`datapath'/version13/2-working/pop_wpp_2017-10" , replace
note: TS This dataset prepared using 2000-2018 census & estimate populations generated from "https://population.un.org/wpp/Download/Standard/Population/" on 27-Nov-2019.
restore
...
save "`datapath'/version13/2-working/pop_wpp_2018-5" , replace
note: TS This dataset prepared using 2000-2018 census & estimate populations generated from "https://population.un.org/wpp/Download/Standard/Population/" on 27-Nov-2019.
restore
...
save "`datapath'/version13/2-working/pop_wpp_2018-10" , replace
note: TS This dataset prepared using 2000-2018 census & estimate populations generated from "https://population.un.org/wpp/Download/Standard/Population/" on 27-Nov-2019.
restore
...
save "`datapath'/version13/2-working/pop_wpp_2019-5" , replace
...
save "`datapath'/version13/2-working/pop_wpp_2019-10" , replace
note: TS This dataset prepared using 2000-2018 census & estimate populations generated from "https://population.un.org/wpp/Download/Standard/Population/" on 10-May-2022.
restore
...
save "`datapath'/version13/2-working/pop_wpp_2020-5" , replace
note: TS This dataset prepared using 2000-2018 census & estimate populations generated from "https://population.un.org/wpp/Download/Standard/Population/" on 10-May-2022.
restore
...
save "`datapath'/version13/2-working/pop_wpp_2020-10" , replace
note: TS This dataset prepared using 2000-2018 census & estimate populations generated from "https://population.un.org/wpp/Download/Standard/Population/" on 10-May-2022.
restore

...
** DATA PREPARATION  
**************************************
** LOAD the national registry deaths 2011-2016 dataset (Note: the deathid will not match redcap record_id)
import excel using "`datapath'\version01\1-input\Cleaned_DeathData_2008-2017_JC_20180705_excel.xlsx" , firstrow case(lower) clear

...
** Rectum (female)
count if dxyr==2013 & siteiarc==14 & sex==1
replace absolutetot = r(N) if dxyr==2013 & siteiarc==14 & sex==1

count if dxyr==2014 & siteiarc==14 & sex==1
replace absolutetot = r(N) if dxyr==2014 & siteiarc==14 & sex==1

count if dxyr==2015 & siteiarc==14 & sex==1
replace absolutetot = r(N) if dxyr==2015 & siteiarc==14 & sex==1

** Rectum (male)
count if dxyr==2013 & siteiarc==14 & sex==2
replace absolutetot = r(N) if dxyr==2013 & siteiarc==14 & sex==2

count if dxyr==2014 & siteiarc==14 & sex==2
replace absolutetot = r(N) if dxyr==2014 & siteiarc==14 & sex==2

count if dxyr==2015 & siteiarc==14 & sex==2
replace absolutetot = r(N) if dxyr==2015 & siteiarc==14 & sex==2
...
drop age
sort siteiarc dxyr
contract siteiarc dxyr sex absolutetot //absolutetotall
drop _freq
rename dxyr year
sort siteiarc year
...
** Rectum (female)
count if agegroup==1 & siteiarc==14 & sex==1
replace cases = r(N) if agegroup==1 & siteiarc==14 & sex==1
count if agegroup==2 & siteiarc==14 & sex==1
replace cases = r(N) if agegroup==2 & siteiarc==14 & sex==1
count if agegroup==3 & siteiarc==14 & sex==1
replace cases = r(N) if agegroup==3 & siteiarc==14 & sex==1
count if agegroup==4 & siteiarc==14 & sex==1
replace cases = r(N) if agegroup==4 & siteiarc==14 & sex==1
count if agegroup==5 & siteiarc==14 & sex==1
replace cases = r(N) if agegroup==5 & siteiarc==14 & sex==1
count if agegroup==6 & siteiarc==14 & sex==1
replace cases = r(N) if agegroup==6 & siteiarc==14 & sex==1
count if agegroup==7 & siteiarc==14 & sex==1
replace cases = r(N) if agegroup==7 & siteiarc==14 & sex==1
count if agegroup==8 & siteiarc==14 & sex==1
replace cases = r(N) if agegroup==8 & siteiarc==14 & sex==1
count if agegroup==9 & siteiarc==14 & sex==1
replace cases = r(N) if agegroup==9 & siteiarc==14 & sex==1
count if agegroup==10 & siteiarc==14 & sex==1
replace cases = r(N) if agegroup==10 & siteiarc==14 & sex==1
count if agegroup==11 & siteiarc==14 & sex==1
replace cases = r(N) if agegroup==11 & siteiarc==14 & sex==1
count if agegroup==12 & siteiarc==14 & sex==1
replace cases = r(N) if agegroup==12 & siteiarc==14 & sex==1
count if agegroup==13 & siteiarc==14 & sex==1
replace cases = r(N) if agegroup==13 & siteiarc==14 & sex==1
count if agegroup==14 & siteiarc==14 & sex==1
replace cases = r(N) if agegroup==14 & siteiarc==14 & sex==1
count if agegroup==15 & siteiarc==14 & sex==1
replace cases = r(N) if agegroup==15 & siteiarc==14 & sex==1
count if agegroup==16 & siteiarc==14 & sex==1
replace cases = r(N) if agegroup==16 & siteiarc==14 & sex==1
count if agegroup==17 & siteiarc==14 & sex==1
replace cases = r(N) if agegroup==17 & siteiarc==14 & sex==1
count if agegroup==18 & siteiarc==14 & sex==1
replace cases = r(N) if agegroup==18 & siteiarc==14 & sex==1

** Rectum (male)
count if agegroup==1 & siteiarc==14 & sex==2
replace cases = r(N) if agegroup==1 & siteiarc==14 & sex==2
count if agegroup==2 & siteiarc==14 & sex==2
replace cases = r(N) if agegroup==2 & siteiarc==14 & sex==2
count if agegroup==3 & siteiarc==14 & sex==2
replace cases = r(N) if agegroup==3 & siteiarc==14 & sex==2
count if agegroup==4 & siteiarc==14 & sex==2
replace cases = r(N) if agegroup==4 & siteiarc==14 & sex==2
count if agegroup==5 & siteiarc==14 & sex==2
replace cases = r(N) if agegroup==5 & siteiarc==14 & sex==2
count if agegroup==6 & siteiarc==14 & sex==2
replace cases = r(N) if agegroup==6 & siteiarc==14 & sex==2
count if agegroup==7 & siteiarc==14 & sex==2
replace cases = r(N) if agegroup==7 & siteiarc==14 & sex==2
count if agegroup==8 & siteiarc==14 & sex==2
replace cases = r(N) if agegroup==8 & siteiarc==14 & sex==2
count if agegroup==9 & siteiarc==14 & sex==2
replace cases = r(N) if agegroup==9 & siteiarc==14 & sex==2
count if agegroup==10 & siteiarc==14 & sex==2
replace cases = r(N) if agegroup==10 & siteiarc==14 & sex==2
count if agegroup==11 & siteiarc==14 & sex==2
replace cases = r(N) if agegroup==11 & siteiarc==14 & sex==2
count if agegroup==12 & siteiarc==14 & sex==2
replace cases = r(N) if agegroup==12 & siteiarc==14 & sex==2
count if agegroup==13 & siteiarc==14 & sex==2
replace cases = r(N) if agegroup==13 & siteiarc==14 & sex==2
count if agegroup==14 & siteiarc==14 & sex==2
replace cases = r(N) if agegroup==14 & siteiarc==14 & sex==2
count if agegroup==15 & siteiarc==14 & sex==2
replace cases = r(N) if agegroup==15 & siteiarc==14 & sex==2
count if agegroup==16 & siteiarc==14 & sex==2
replace cases = r(N) if agegroup==16 & siteiarc==14 & sex==2
count if agegroup==17 & siteiarc==14 & sex==2
replace cases = r(N) if agegroup==17 & siteiarc==14 & sex==2
count if agegroup==18 & siteiarc==14 & sex==2
replace cases = r(N) if agegroup==18 & siteiarc==14 & sex==2
...
order siteiarc year sex table_means table_low table_high
...
** Create dataset by year by site by sex (where applicable) - RECTUM (2013-female)
use "`datapath'\version02\2-working\2013_2014_2015_pre-uncertainty_allsites", clear
...
save "`datapath'\version02\2-working\2013_nouncertainty_rectumF", replace
...
forvalues i = 1(1)`boots' {
	...
	use "`datapath'\version02\2-working\2013_nouncertainty_rectumF", clear
...
save "`datapath'\version02\2-working\2013_boots_rectumF", replace
...
order siteiarc year sex table_means table_low table_high
save "`datapath'\version02\3-output\2013_uncertainty_rectumF", replace
...
** Create dataset by year by site by sex (where applicable) - RECTUM (2014-female)
use "`datapath'\version02\2-working\2013_2014_2015_pre-uncertainty_allsites", clear
...
save "`datapath'\version02\2-working\2014_nouncertainty_rectumF", replace
...
forvalues i = 1(1)`boots' {
	...
	use "`datapath'\version02\2-working\2014_nouncertainty_rectumF", clear
...
save "`datapath'\version02\2-working\2014_boots_rectumF", replace
...
order siteiarc year sex table_means table_low table_high
save "`datapath'\version02\3-output\2014_uncertainty_rectumF", replace
...
** Create dataset by year by site by sex (where applicable) - RECTUM (2015-female)
use "`datapath'\version02\2-working\2013_2014_2015_pre-uncertainty_allsites", clear
...
save "`datapath'\version02\2-working\2015_nouncertainty_rectumF", replace
...
forvalues i = 1(1)`boots' {
	...
	use "`datapath'\version02\2-working\2015_nouncertainty_rectumF", clear
...
save "`datapath'\version02\2-working\2015_boots_rectumF", replace
...
order siteiarc year sex table_means table_low table_high
save "`datapath'\version02\3-output\2015_uncertainty_rectumF", replace
...
** Create dataset by year by site by sex (where applicable) - RECTUM (2013-male)
use "`datapath'\version02\2-working\2013_2014_2015_pre-uncertainty_allsites", clear
...
save "`datapath'\version02\2-working\2013_nouncertainty_rectumM", replace
...
forvalues i = 1(1)`boots' {
	...
	use "`datapath'\version02\2-working\2013_nouncertainty_rectumM", clear
...
save "`datapath'\version02\2-working\2013_boots_rectumM", replace
...
order siteiarc year sex table_means table_low table_high
save "`datapath'\version02\3-output\2013_uncertainty_rectumM", replace
...
** Create dataset by year by site by sex (where applicable) - RECTUM (2014-male)
use "`datapath'\version02\2-working\2013_2014_2015_pre-uncertainty_allsites", clear
...
save "`datapath'\version02\2-working\2014_nouncertainty_rectumM", replace
...
forvalues i = 1(1)`boots' {
	...
	use "`datapath'\version02\2-working\2014_nouncertainty_rectumM", clear
...
save "`datapath'\version02\2-working\2014_boots_rectumM", replace
...
order siteiarc year sex table_means table_low table_high
save "`datapath'\version02\3-output\2014_uncertainty_rectumM", replace
...
save "`datapath'\version02\2-working\2015_nouncertainty_rectumM", replace
...
forvalues i = 1(1)`boots' {
	...
	use "`datapath'\version02\2-working\2015_nouncertainty_rectumM", clear
...
save "`datapath'\version02\2-working\2015_boots_rectumM", replace
...
order siteiarc year sex table_means table_low table_high
save "`datapath'\version02\3-output\2015_uncertainty_rectumM", replace
...
append using "`datapath'\version02\3-output\2013_uncertainty_rectumF"
append using "`datapath'\version02\3-output\2014_uncertainty_rectumF"
append using "`datapath'\version02\3-output\2015_uncertainty_rectumF"
append using "`datapath'\version02\3-output\2013_uncertainty_rectumM"
append using "`datapath'\version02\3-output\2014_uncertainty_rectumM"
append using "`datapath'\version02\3-output\2015_uncertainty_rectumM"
...
merge 1:1 siteiarc year sex using "`datapath'\version02\2-working\2013_2014_2015_absolutetotals"
/*
...
sort siteiarc sex year mean min max
format min max %2.0f
format mean %2.1f
...
putdocx save "`datapath'\version02\3-output\2021-10-04_uncertainty_stats_V04.docx", replace
putdocx clear

...
import excel using "`datapath'\version09\1-input\BNRDeathData20082021-CancerMatching2021De_DATA_2022-07-20_0633_excel.xlsx" , firstrow case(lower)

count //3133; 3136; 3142; 3143 - note: there are 3 cases from 2020 that were collected after 2020 was cleaned
...
------------+-----------------------------------
       ...
       2020 |      2,606       14.04       83.08
       2021 |      3,140       16.92      100.00
------------+-----------------------------------
      Total |     18,559      100.00
*/

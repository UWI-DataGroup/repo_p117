...
*Merge in female parish population by 5-year age bands for Barbados
merge m:m parish age5 using "`datapath'/version14/2-working/female_parish_bb_pop.dta"

*Remove any possible duplicates found
...
*******
/*
Old command - DO not use (Kept for future reference)
...
*Collapse file by parish 5-year age bands and year of diagnosis
collapse (sum) case (mean) female_pop, by(parish age5 age_10 dxyr)

*Add in missing age groups based on distribution from tabulation of 5-year 
preserve
keep if dxyr == 2015
set obs 85

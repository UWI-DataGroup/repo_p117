** HEADER -----------------------------------------------------
**  DO-FILE METADATA
    //  algorithm name			7_external_pop_da.do
    //  project:				BNR
    //  analysts:				Jacqueline CAMPBELL
    //  date first created      27-MAR-2019
    // 	date last modified	    27-MAR-2019
    //  algorithm task			Prep for external population for incidence analysis
    //  status                  Completed
    ...
    ** Close any open log file and open a new log file
    capture log close
    log using "`logpath'\7_ext_pop_2014_da.smcl", replace
** HEADER -----------------------------------------------------
...
** Save the dataset
save "`datapath'\version01\2-working\bb2010_5" , replace

preserve
collapse (sum) pop_bb, by(age10 age60 sex)
label data "Barbados census 2010: 10-year age bands1"
** Save the dataset
save "`datapath'\version01\2-working\bb2010_10-1" , replace

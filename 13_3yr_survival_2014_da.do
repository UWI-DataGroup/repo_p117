...
**  DO-FILE METADATA
    ...
    ** Close any open log file and open a new log file
    capture log close
    log using "`logpath'\13_3yr_survival_2014_da.smcl", replace
** HEADER -----------------------------------------------------
...
----------------------+-----------------------------------
                    0 |        438       48.03       48.03
                 dead |        474       51.97      100.00
----------------------+-----------------------------------
                Total |        912      100.00
*/

** Save this new dataset 
save "`datapath'\version01\2-working\2014_3yr_survival_da", replace
label data "2014 BNR-Cancer analysed data - 3yr Survival"

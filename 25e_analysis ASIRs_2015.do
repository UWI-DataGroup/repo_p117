...
------------+-----------------------------------
     female |        577       52.84       52.84
       male |        515       47.16      100.00
------------+-----------------------------------
      Total |      1,092      100.00
*/
...
FEMALE 2018 top 5:
	...
	multiple myeloma
*/
//use "`datapath'\version09\2-working\2015_cancer_dataset_popn", clear //remove after below code is complete
...
order cancer_site number percent asir ci_lower ci_upper
sort cancer_site number
save "`datapath'\version09\2-working\ASIRs_2015_male" ,replace
restore
...
/*
  ...
  | case        N   crude   rateadj   lb_gam   ub_gam   se_gam |
  |------------------------------------------------------------|
  |   61   137548   44.35     27.64    21.00    35.99     3.69 |
  +------------------------------------------------------------+
*/
** JC update: Save these results as a dataset for reporting
matrix list r(adj)
...
append using "`datapath'\version09\2-working\ASIRs_2015_male" 
replace cancer_site=3 if cancer_site==.
replace year=4 if year==.
order cancer_site number percent asir ci_lower ci_upper
sort cancer_site number
...
/*
  ...
  | case        N   crude   rateadj   lb_gam   ub_gam   se_gam |
  |------------------------------------------------------------|
  |   21   137548   15.27     10.85     6.70    16.88     2.48 |
  +------------------------------------------------------------+
*/
** JC update: Save these results as a dataset for reporting
matrix list r(adj)
...
/*
  ...
  | case        N   crude   rateadj   lb_gam   ub_gam   se_gam |
  |------------------------------------------------------------|
  |   21   137548   15.27     10.64     6.54    16.61     2.45 |
  +------------------------------------------------------------+
*/
** JC update: Save these results as a dataset for reporting
matrix list r(adj)
...
/*
  ...
  | case        N   crude   rateadj   lb_gam   ub_gam   se_gam |
  |------------------------------------------------------------|
  |    9   137548    6.54      4.41     1.98     8.81     1.66 |
  +------------------------------------------------------------+
*/
** JC update: Save these results as a dataset for reporting
matrix list r(adj)
...
order cancer_site number percent asir ci_lower ci_upper
sort cancer_site number
save "`datapath'\version09\2-working\ASIRs_2015_female" ,replace
restore
...
/*
  ...
  | case        N   crude   rateadj   lb_gam   ub_gam   se_gam |
  |------------------------------------------------------------|
  |   57   147779   38.57     23.08    17.30    30.47     3.24 |
  +------------------------------------------------------------+
*/
** JC update: Save these results as a dataset for reporting
matrix list r(adj)
...
append using "`datapath'\version09\2-working\ASIRs_2015_female" 
replace cancer_site=3 if cancer_site==.
replace year=4 if year==.
order cancer_site number percent asir ci_lower ci_upper
sort cancer_site number
...
/*
  ...
  | case        N   crude   rateadj   lb_gam   ub_gam   se_gam |
  |------------------------------------------------------------|
  |   16   147779   10.83      4.64     2.54     8.40     1.42 |
  +------------------------------------------------------------+
*/
** JC update: Save these results as a dataset for reporting
matrix list r(adj)
...
/*
  ...
  | case        N   crude   rateadj   lb_gam   ub_gam   se_gam |
  |------------------------------------------------------------|
  |   22   147779   14.89      8.12     5.00    12.89     1.92 |
  +------------------------------------------------------------+
*/
** JC update: Save these results as a dataset for reporting
matrix list r(adj)

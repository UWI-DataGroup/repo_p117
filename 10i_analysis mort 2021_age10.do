** HEADER -----------------------------------------------------
**  DO-FILE METADATA
    //  algorithm name          10i_analysis mort_2021_age10.do
    //  project:                BNR
    ...
    ** Close any open log file and open a new log file
    capture log close
    log using "`logpath'\10i_analysis mort_2021_age10.smcl", replace
** HEADER -----------------------------------------------------
...
merge m:m sex age_10 using "`datapath'\version09\2-working\pop_wpp_2021-10"
/*
...
list record_id sex age_10 if (age_10==1 & sex==2)|age_10==2 // age range 0-14 and 15-24 for male: change case=0 for age_10=1 and age_10=2
replace case=0 if (age_10==1 & sex==2)|age_10==2 //3 changes
...
list siteiarc age sex age_10 case if age==.|age==999 //this is missing age_10: 0-14 and 15-24 so no change needed

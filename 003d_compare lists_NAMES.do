...
count if dupnmpid>0 //58
order registrynumber lastname firstname checked dupnmpid str_no str_da str_dadate str_action

count if checked==2 & dupnmpid>0 //29 - so all 29 have a corresponding pid that's from previously-checked list so can no new dups found in this list
count if checked==1 & duppid==0 //8 - check these in Stata Browse/Edit window: previously-checked and merged cases
...
count if dupnmpid==0 //41 - check these in Stata Browse/Edit window: previously-checked and merged cases + new duplicate cases for those with 2 records
drop if dupnmpid>0 & registrynumber!=20170127 & registrynumber!=20171059 & registrynumber!=20190500 & registrynumber!=20200471 ///
					 & registrynumber!=20130868 & registrynumber!=20170404 & registrynumber!=20141295 & registrynumber!=20170405 ///

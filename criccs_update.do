...
**  DO-FILE METADATA
    ...
    ** Close any open log file and open a new log file
    capture log close
    log using "`logpath'\criccs_update.smcl", replace
** HEADER -----------------------------------------------------

/*
	JC 17jan2023: The datasets in this dofile were previously submitted to the CRICCS study on 31-oct-2021
*/
** LOAD identifiable cancer incidence dataset INCLUDING DCOs from version09 (2016-2018 annual report cleaning and analysis)
...
count if v57==. //0
count //2798
capture export_excel using "`datapath'\version11\3-output\CRICCS_LONG_V04.xlsx", sheet("2013-2018all") firstrow(variables) nolabel replace
...
capture export_excel using "`datapath'\version11\3-output\CRICCS_WIDE_V04.xlsx", sheet("2013-2018child") firstrow(variables) nolabel replace

restore


** Save this corrected dataset with internationally reportable cases
save "`datapath'\version11\3-output\2013-2018_cancer_criccs", replace

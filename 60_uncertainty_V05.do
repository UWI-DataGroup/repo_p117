...
** Adjust age group options for CERVIX
gen agegroup = 1 if age<5 & age<15
replace agegroup = 2 if age>14 & age<30
replace agegroup = 3 if age>29 & age<45
replace agegroup = 4 if age>44 & age<60
replace agegroup = 5 if age>59 & age<75
replace agegroup = 6 if age>74

label define agegroup_lab 	1 "00-14"  2 "15-29"  3 "30-44"	///
							4 "45-59"  5 "60-74"  6 "75-85+" , modify
...
sort siteiarc year mean min max
format min max %2.0f
format mean %2.1f
...
putdocx save "`datapath'\version02\3-output\2021-10-04_uncertainty_stats_V05.docx", replace
putdocx clear

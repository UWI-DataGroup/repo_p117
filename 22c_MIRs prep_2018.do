** HEADER -----------------------------------------------------
**  DO-FILE METADATA
    //  algorithm name          22c_MIRs prep_2018.do
	//  project:                BNR
    //  analysts:               Jacqueline CAMPBELL
    //  date first created      22-AUG-2022
    // 	date last modified      22-AUG-2022
    //  algorithm task          Creating IARC site variable on 2018 mortality dataset in preparation for mortality:incidence ratio analysis
    //  status                  Completed
    ...
    ** Close any open log file and open a new log file
    capture log close
    log using "`logpath'\22c_MIRs prep_2018.smcl", replace
** HEADER -----------------------------------------------------
...
**************************************************************************
use "`datapath'\version09\3-output\2018_prep mort_identifiable", clear
...
save "`datapath'\version09\2-working\2018_mir_mort_prep", replace
...
save "`datapath'\version09\2-working\2018_mir_mort", replace
...
** Create death dataset with CODs assigned a site code
save "`datapath'\version09\2-working\2018_mir_incid_prep", replace
...
** Create death dataset to use for mortality:incidence ratio
save "`datapath'\version09\2-working\2018_mir_incid", replace

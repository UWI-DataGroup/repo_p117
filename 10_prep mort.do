...
export_excel record_id dddoa ddda odda pname regnum district nrn if event==1 & dupreg>0 using "`datapath'\version02\2-working\2021-07-27_deaths_dups_2019_V02.xlsx", firstrow(variables) replace
